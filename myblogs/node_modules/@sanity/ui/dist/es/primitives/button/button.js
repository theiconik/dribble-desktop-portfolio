...
const Button = forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Root, __objSpread(__objSpread({
    ...
    ref,
    type
  }), Boolean(loading) && /* @__PURE__ */ React.createElement(LoadingBox, null, /* @__PURE__ */ React.createElement(Spinner, null)), (icon || text || iconRight) && /* @__PURE__ */ React.createElement(Box, __objSpread({
    as: "span"
