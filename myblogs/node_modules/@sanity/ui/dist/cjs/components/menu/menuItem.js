...
const MenuItem = (0, import_react.forwardRef)((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_primitives.Card, __objSpread(__objSpread({
    as: "button",
    "data-ui": "MenuItem"
  }, restProps), {
    disabled,
    ...
    tabIndex: -1,
    type: "button"
  }), (icon || text || iconRight) && /* @__PURE__ */ import_react.default.createElement(import_primitives.Box, __objSpread({
    as: "span"
