...
function responsiveInputPaddingIconsStyle(props) {
  return responsiveInputPaddingStyle(__objSpread(__objSpread({}, props), {$iconLeft: true, $iconRight: true}));
}
function responsiveInputPaddingIconLeftStyle(props) {
  return responsiveInputPaddingStyle(__objSpread(__objSpread({}, props), {$iconLeft: true}));
}
function responsiveInputPaddingIconRightStyle(props) {
  return responsiveInputPaddingStyle(__objSpread(__objSpread({}, props), {$iconRight: true}));
}
